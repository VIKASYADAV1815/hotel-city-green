...
export default function Footer() {
  return (
    <footer className="bg-olive text-cream pt-24 pb-12">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left mb-16">
          ...
          <div className="flex flex-col items-center md:items-start col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full border border-cream/20 flex items-center justify-center text-cream/70 hover:bg-accent hover:text-white hover:border-accent transition-all">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-xs tracking-widest uppercase font-semibold text-cream mb-6">Newsletter</h4>
            <p className="text-sm text-cream/70 mb-4 text-center md:text-left">
            ...
            <form className="w-full relative">
              <input 
                ...
                className="w-full bg-transparent border-b border-cream/30 py-2 px-0 text-sm text-cream placeholder:text-cream/40 focus:outline-none focus:border-accent transition-colors"
              />
              <button 
                type="button" 
                className="absolute right-0 top-1/2 -translate-y-1/2 text-xs font-bold text-accent hover:text-white transition-colors uppercase tracking-wider"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-cream/10">
          <p className="text-xs text-cream/50 mb-4 md:mb-0 tracking-wide">
            © 2026 Hotel City Green. All Rights Reserved.
          </p>
          <button 
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="w-10 h-10 rounded-full border border-cream/20 flex items-center justify-center hover:bg-accent hover:border-accent hover:text-white transition-all group"
          >
            <ArrowUp className="text-cream/70 group-hover:text-white" size={16} />
          </button>
        </div>
      </div>
    </footer>
